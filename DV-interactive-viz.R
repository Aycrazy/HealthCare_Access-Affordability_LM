...
# aggregate health status and population over 18
hs_countyhealthinfo <- aggregate(health_status ~ range_income + year, countyhealthinfo, median)
pop_countyhealthinfo <- aggregate(num_18plus ~ range_income + year, countyhealthinfo, sum)
